  ...
  <header role="banner" class="l-header">
    ...
    <?php if ($top_bar): ?>
      ...
      <nav class="top-bar" data-topbar <?php print $top_bar_options; ?>>
        <ul class="title-area">
          <?php if ($logo): ?>
          <a class="logo main-logo navbar-btn pull-left" href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>">
        ...
        <section class="top-bar-section">
          ...
          <?php endif; ?>
          <?php if (!empty($top_bar_user_menu)) : ?>
            <?php print $top_bar_user_menu; ?>
          <?php endif; ?>
        </section>
      </nav>
      <?php if ($top_bar_classes): ?>
    ...
    <div class="contain-to-grid secondary">
